...
fun EditTripActivityScreen(
    state: EditTripActivityState,
    actions: EditTripActivityActions,
    ...
    Scaffold(
        ...
        Column(
            ...
            TravelBuddyButton(
                ...
                onClick = {
                    actions.editTripActivity()
                    navController.navigate(TravelBuddyRoute.TripActivities(state.tripId.toString()))
                },
                label = "Edit activity",
